...
msgpool_hard_limit = descriptor.FieldDescriptor(
...
_CMSGPROTOBUFHEADER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='sysid', full_name='CMsgProtoBufHeader.sysid', index=13,
...
_CMSGMULTI = descriptor.Descriptor(
  name='CMsgMulti',
  full_name='CMsgMulti',
  filename=None,
  file=DESCRIPTOR,
...
_CMSGAUTHTICKET = descriptor.Descriptor(
  name='CMsgAuthTicket',
...
_CCDDBAPPDETAILCOMMON = descriptor.Descriptor(
...
_CMSGAPPRIGHTS = descriptor.Descriptor(
  name='CMsgAppRights',
